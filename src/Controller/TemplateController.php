...
//        dd($template);
    ...
    /**
     * @Route("/template/stage/1/create", name="templateStage1Create",methods="POST")
     */
    ...
    /**
     * @Route("/template/stage/1/load", name="templateStage1Load",methods="POST")
     */
    public function stage1Load(\Symfony\Component\HttpFoundation\Request $request)
    {
